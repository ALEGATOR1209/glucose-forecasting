...
from scripts.sugar_jepa.jepa_pretrain import _sinusoidal_table
from scripts.sugar_jepa.sugar_jepa_model import JepaBlock, PositionalEncoding
...
if __name__ == "__main__":
    ...
    from scripts.sugar_jepa.jepa_pretrain import JepaPredictor
